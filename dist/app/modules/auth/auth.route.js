...
router.post('/change-password', (0, auth_1.default)(user_constant_1.USER_ROLES.admin, user_constant_1.USER_ROLES.user), (0, validateRequest_1.default)(auth_validation_1.AuthValidation.changePasswordValidationSchema), (0, auth_1.default)(user_constant_1.USER_ROLES.user), auth_controller_1.AuthControllers.changePassword);
